...
CALL p_sort_templates();
UPDATE `templates_structure` SET `name` = 'type' , `l1` = 'Type' , `l2` = 'Type' , `l3` = 'Type' , `l4` = 'Type' , `type` = '_templateTypesCombo' , `order` = '0' , `cfg` = NULL WHERE NAME = 'main_file';
