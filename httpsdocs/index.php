...
<?php
	...
	if(!empty($customGroupsConfig[CB_PROJ.'_css'])) echo '<link rel="stylesheet" type="text/css" href="'.Minify_getUri(CB_PROJ.'_css', array('groupsConfigFile' => CB_CORES_PATH.'groupsRouter.php' )).'" />';
