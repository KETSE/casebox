...
Ext.define('CB.FileWindow', {
    ...
    ,processLoadProperties: function(r, e){
        ...
        this.setIconCls(getFileIcon(r.data.name));
    ...
    ,prepareInterface: function(){
                    ...
                    if(tb) {
                        if(Ext.isEmpty(objectPanel.loadedData) ||
                            ...
                            (
                                ...
                                (Ext.valueFrom(objectPanel.loadedData.viewIndex, 0) == 0)
                            )
                        ) {
                            tb.hide();
                        } else {
        ...
        this.cardPanel = this.items.getAt(0).items.getAt(0);
