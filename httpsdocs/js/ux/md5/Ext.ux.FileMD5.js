...
Ext.ux.fileMD5 = Ext.extend(Ext.util.Observable, {
	chunkSize: 2097152
	,constructor: function(){
		this.blobSlice = File.prototype.slice || File.prototype.mozSlice || File.prototype.webkitSlice;
		this.fileReader = new FileReader();
		this.fileReader.onload = this.frOnload.createDelegate(this);
		this.fileReader.onerror = this.frOnerror.createDelegate(this);
