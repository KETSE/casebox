...
Ext.define('Ext.ux.TitleField', {
    ...
    ,onTrigger1Click : function(){//clear trigger = switch manual mode to auto
        ...
        this.addCls('title-readonly');
        this.focus();
    }

    ,onTrigger2Click : function(){//this trigger = switch auto to manual
        this.setEditable(true);
        this.setValue(Ext.valueFrom(this.customValue, (this.defaultValue == L.AutoGenerated) ? '' : this.defaultValue));
    ...
    ,setValues: function(defaultValue, customValue){
        ...
        if(this.hasCustomValue) this.removeCls('title-readonly'); else this.addCls('title-readonly');
    }
});
