...
class Search extends SolrClient{
	...
	private function prepareParams(){
		...
		$this->params = array(
			...
			,'qf' => "name content^0.5"
			,'tie' => '0.1'
			,'fl' => "id, pid, path, name, template_type, subtype, system, size, date, date_end, oid, cid, cdate, uid, udate, case_id, case, template_id, user_ids, status, category_id, importance, completed, versions"
			,'sort' => 'ntsc asc'
		);
		/* initial parameters */
