<?php
/**
 * copy for core_create.php using temporary for testing only purposes
 *
 * core instantiation
 *
 * Script params:
...
$pass = '';
do {
    $l = 'test@mail.com'; //readALine('Specify email address for root user:' . "\n");
    $email = $l;
} while (empty($l));

do {
    $l = 'r00t';//readALine('Specify root user password:' . "\n");
    $pass = $l;
} while (empty($l));
