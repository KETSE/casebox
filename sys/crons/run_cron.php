...
if(sizeof($argv) < 3) die('Not enough parameters specified. Use run_cron.php <cron_name> <core_name>/all ');
...
if( !file_exists($cron_path.$cron_file)) die('cannot find cron '.$cron_path.$cron_file);
